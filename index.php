...
<body>
				...
				<div class="row pb-5">
					<div class="col-lg-6 col-12">
						<div class="text-center text-md-start text-white">
							<div class="mb-5">
								<h1 class="display-1 pb-2" data-aos="fade-up" data-aos-duration="600">Delicious Food for
									any _____ </h1>
								<p class="text-secondary-emphasis lead" data-aos="fade-up" data-aos-duration="700">
									Cras eu elit congue, ________ dui ut, tincidunt nislnulla ___ elit, pharetra
									bibendum justo __________ consectetur erat.
								</p>
							</div>
							<div
				...
				<div class="col-lg-4 col-12" data-aos="fade-up" data-aos-duration="600">
					<div class="bg-success text-center text-white p-5">
						...
						<div class="pt-4">
							...
							<p class="text-white-50 mb-0">Aenean non accumsan ante. ____ et risus accumsan sem ______
								porta nec sit amet ___. Sed ut euismod quam. </p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-12" data-aos="fade-up" data-aos-duration="700">
					<div class="bg-success bg-opacity-75 text-center text-white p-5">
						...
						<div class="pt-4">
							...
							<p class="text-white-50 mb-0">Phasellus risus turpis, pretium ___ amet magna non, molestie
								_________ enim. Nullam pulvinar felis __ metus. </p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-12" data-aos="fade-up" data-aos-duration="800">
					<div class="bg-success bg-opacity-50 text-center text-white p-5">
						...
						<div class="pt-4">
							...
							<p class="text-white-50 mb-0">Donec dapibus mauris id ____ ornare tempus. Duis sit ____
								accumsan justo, quis tempor ______ quisque. </p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row justify-content-center mb-5">
				<div class="col-xl-7 col-lg-8 col-md-10 col-12">
					<div class="text-center" data-aos="fade-up" data-aos-duration="600">
						...
						<p>Donec convallis, elit vitae ______ cursus, libero purus facilisis ______ volutpat metus
							tortor bibendum ____. Integer nec mi eleifend, _________ lorem vitae, finibus neque. </p>
					</div>
				</div>
			</div>
			<div class="row g-4">
				<div class="col-lg-4 col-12" data-aos="fade-up" data-aos-duration="600">
					<div class="card bg-light border-0 rounded-0 text-center p-5">
						...
						<div class="card-body">
							...
							<p class="card-text">In consequat, quam id _______ hendrerit, eros mi molestie ___, nec
								lacinia risus. </p>
						</div>
					...
					<div class="text-center">
						<div class="mb-5">
							...
							<p class="lead fw-normal" data-aos="fade-up" data-aos-duration="700">
								Aliquam faucibusodio nec commodo _______, neque felis placerat dui, _ porta ante lectus
								dapibus ___. Aliquam a bibendum mised. ___________ vestibulum quis dapibus sit ____,
								finibus id turpis. Aliquam
								semper _________ semper.
							</p>
						</div>
	...
	<div class="py-5">
		<div class="container py-5">
			...
			<div class="row g-4">
				<div class="col-lg-6 col-12" data-aos="fade-up" data-aos-duration="600">
					<div class="card border-0 rounded-0 h-100">
						...
						<div class="card-img-overlay d-flex align-items-end p-4">
							<div class="bg-white text-center p-5">
								...
								<p class="card-text">Praesent libero augue, ornare ____ quam sed, volutpat suscipit ____
									duis ut urna commodo. </p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-12" data-aos="fade-up" data-aos-duration="700">
					<div class="card border-0 rounded-0 h-100">
				...
				<div class="col-lg-6 col-12" data-aos="fade-up" data-aos-duration="800">
					<div class="card border-0 rounded-0 h-100">
				...
				<div class="col-lg-6 col-12" data-aos="fade-up" data-aos-duration="900">
					<div class="card border-0 rounded-0 h-100">
				...
				<div class="col-xl-7 col-lg-8 col-md-10 col-12">
					...
					<div>
						<div class="card bg-transparent border-0 rounded-0 mb-4">
							<div class="row align-items-center g-2" data-aos="fade-up" data-aos-duration="600">
								<div class="col-md-2 col-12" data-aos="fade-up" data-aos-duration="600">
									<img src="img/today-menu/menu-image-1.png" class="img-fluid d-block mx-auto"
										alt="today-menu" />
								</div>
								<div class="col-md-10 col-12">
									<div class="card-body text-center text-md-start">
										...
										<p class="card-text text-white-50 mb-0">Vestibulum commodo sapien non ____
											porttitor vitae eiusmod. </p>
									</div>
								</div>
							</div>
						</div>
						<div class="card bg-transparent border-0 rounded-0 mb-4">
							<div class="row align-items-center g-2" data-aos="fade-up" data-aos-duration="700">
								<div class="col-md-2 col-12">
									<img src="img/today-menu/menu-image-2.png" class="img-fluid d-block mx-auto"
										alt="today-menu" />
								</div>
								<div class="col-md-10 col-12">
									<div class="card-body text-center text-md-start">
										...
										<p class="card-text text-white-50 mb-0">Pellentesque tincidunt tristique neque
											____ venenatis vulputate </p>
									</div>
								</div>
							</div>
						</div>
						<div class="card bg-transparent border-0 rounded-0 mb-4">
							<div class="row align-items-center g-2" data-aos="fade-up" data-aos-duration="800">
								<div class="col-md-2 col-12">
									<img src="img/today-menu/menu-image-3.png" class="img-fluid d-block mx-auto"
										alt="today-menu" />
								</div>
								<div class="col-md-10 col-12">
									<div class="card-body text-center text-md-start">
						...
						<div class="card bg-transparent border-0 rounded-0">
							<div class="row align-items-center justify-content-center g-2" data-aos="fade-up"
								data-aos-duration="900">
								<div class="col-md-2 col-12">
									<img src="img/today-menu/menu-image-4.png" class="img-fluid d-block mx-auto"
										alt="today-menu" />
								</div>
								<div class="col-md-10 col-12">
									<div class="card-body text-center text-md-start">
										...
										<p class="card-text text-white-50 mb-0">Duis rhoncus dui venenatis _________
											portitortiam commodo. </p>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="container py-5">
			...
			<div class="row g-4">
				<div class="col-lg-4 col-12" data-aos="fade-up" data-aos-duration="600">
					<div class="card bg-light border-0 rounded-0 text-center p-5 h-100">
						<div class="card-header bg-transparent border-0">
							<img src="img/profile/profile-1.jpg" class="img-fluid rounded-circle client-img"
								alt="our-client" />
						</div>
						<div class="card-body py-4">
							<p class="card-text">In consequat, quam id _______ hendrerit, eros mi molestie ___, nec
								lacinia risus neque _________ augue. Proin tempus urna ___ congue elementum. </p>
						</div>
				...
				<div class="col-lg-4 col-12" data-aos="fade-up" data-aos-duration="700">
					<div class="card bg-light border-0 rounded-0 text-center p-5 h-100">
						<div class="card-header bg-transparent border-0">
							<img src="img/profile/profile-4.jpg" class="img-fluid rounded-circle client-img"
								alt="our-client" />
						</div>
						<div class="card-body py-4">
							<p class="card-text">In consequat, quam id _______ hendrerit, eros mi molestie ___, nec
				...
				<div class="col-lg-4 col-12" data-aos="fade-up" data-aos-duration="800">
					<div class="card bg-light border-0 rounded-0 text-center p-5 h-100">
						<div class="card-header bg-transparent border-0">
							<img src="img/profile/profile-5.jpg" class="img-fluid rounded-circle client-img"
								alt="our-client" />
						</div>
						<div class="card-body py-4">
							<p class="card-text">In consequat, quam id _______ hendrerit, eros mi molestie ___, nec
				...
				<div class="col-12">
					<div class="card text-bg-dark border-0 rounded-0 h-100">
						...
						<div class="card-img-overlay d-flex align-items-center justify-content-center text-center">
							<div class="row justify-content-center">
								<div class="col-xl-7 col-lg-8 col-md-10 col-12">
									<h1 class="card-title title pb-2" data-aos="fade-up" data-aos-duration="600">
										Subscribe and get 20% ________ </h1>
									<p class="card-text" data-aos="fade-up" data-aos-duration="700">
